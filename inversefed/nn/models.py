    ...
    if model in ["ConvNet", "ConvNet64"]:
        ...
        inverted_residual_setting = [
            ...
            [
                ...
                2,
                1,
            ],  # cifar adaptation, cf.https://github.com/kuangliu/pytorch-cifar/blob/master/models/mobilenetv2.py
            [6, 32, 3, 2],
            [6, 64, 4, 2],
            [6, 96, 3, 1],
            [6, 160, 3, 2],
        ...
        model.features[0] = torchvision.models.mobilenet.ConvBNReLU(
            num_channels, 32, stride=1
        )  # this is fixed to width=1
    elif model == "MNASNet":
        ...
        model = _DenseNet(
            _Bottleneck, [6, 6, 6, 0], growth_rate=12, num_classes=num_classes
        )
    elif model == "DenseNet40-4":
        model = _DenseNet(
            _Bottleneck, [6, 6, 6, 0], growth_rate=12 * 4, num_classes=num_classes
        )
    elif model == "SRNet3":
        ...
        model = LeNet5(num_channels=num_channels, num_classes=num_classes)
    else:
